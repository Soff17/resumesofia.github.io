!function(e, t) {
    ...
    return function() {
        ...
        this.ScrollReveal = function() {
            ...
            function s(t, n) {
                t.config ? t.config = e.tools.extendClone(t.config, n) : t.config = e.tools.extendClone(e.defaults, n),
            ...
            function c(e) {
                ...
                parseInt(t.distance) && (n.initial += " translate" + t.axis + "(" + t.distance + ")", n.target += " translate" + t.axis + "(0)"),
            ...
            return i.prototype.defaults = {
                ...
                i && "number" == typeof i && (w = r(), g = e.sequences[w] = {
                    id: w,
                    interval: i,
                    elemIds: [],
                    active: !1
                ...
                for (var v = 0; v < y.length; v++)
                    ...
                    a(m),
                    f(m),
                    e.tools.isMobile() && !m.config.mobile || !e.isSupported() ? (m.domEl.setAttribute("style", m.styles.inline), m.disabled = !0) : m.revealing || m.domEl.setAttribute("style", m.styles.inline + m.styles.transform.initial);
